        ...
        <div class="container md:mt-10 lg:mt-10">
            <div class="flex flex-wrap px-6">
                <div class="w-full self-end lg:w-1/2">
                    <div class="relative">
                        <img src="{{asset('assets/img/orang3.png')}}" alt="" class="z-10 relative max-w-full w-[398px] mx-auto" id="orang"/>
                    </div>
                </div>
                <div class="w-full self-center pr-10 lg:w-1/2 md:mt-20 lg:mt-0">
                    <h1 class="text-white font-bold text-3xl md:text-center lg:text-justify" id="judul">Bagas Haidar</h1>
                    <div class="h-[200px] overflow-auto pr-2">
                        <p class="text-white mt-5 font text-xl font-bold text-justify" id="judul2">VISI :</p>
                        <p class="text-slate-300 mt-2 font font-normal text-justify" id="judul2">Menjadikan OSIS menjadi satu organisasi yang bermutu dan berkualitas tinggi, sekaligus mengharumkan nama baik sekolah.</p>
                        <p class="text-white mt-5 font text-xl font-bold text-justify" id="judul2">MISI :</p>
                        <p class="text-slate-300 mt-2 font font-normal text-justify" id="judul2">Melaksanakan program kerja hasil musyawarah, mengembangkan kreativitas dan bakat siswa, dan mempererat tali persaudaraan antar osis dengan siswa dan organisasi lainnya.</p>
                        <p class="text-white mt-5 font text-xl font-bold text-justify" id="judul2">PROGRAM KERJA :</p>
                        <p class="text-slate-300 mt-2 font font-normal text-justify" id="judul2">1. ⁠Mengadakan rapat sesama osis dan organisasi lainnya ketika ada acara untuk mengurangi adanya miskomunikasi.</p>
                        <p class="text-slate-300 mt-2 font font-normal text-justify" id="judul2">2. Memperbanyak poster tentang edukasi menjaga lingkungan sekolah dan motivasi untuk siswa agar belajar lebih giat lagi.</p>
                        <p class="text-slate-300 mt-2 font font-normal text-justify" id="judul2">3. Membuat kotak saran untuk menampung inspirasi dan aspirasi dari siswa dan siswi.</p>
                    </div>
                    <div class="flex w-full">
                        <div class="md:mx-auto lg:mx-0 flex flex-wrap">
                            ...
                            <form action="/kandidats3" method="POST" id="myForm">
                                @csrf
