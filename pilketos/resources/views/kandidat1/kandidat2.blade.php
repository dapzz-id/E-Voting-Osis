        ...
        <div class="container md:mt-10 lg:mt-10">
            <div class="flex flex-wrap px-6">
                <div class="w-full self-end lg:w-1/2">
                    <div class="relative">
                        <img src="{{asset('assets/img/orang2.png')}}" alt="" class="z-10 relative max-w-full w-[390px] mx-auto" id="orang"/>
                    </div>
                </div>
                <div class="w-full self-center pr-10 lg:w-1/2 md:mt-20 lg:mt-0">
                    <h1 class="text-white font-bold text-3xl md:text-center lg:text-justify" id="judul">Rizky Fadillah</h1>
                    <div class="h-[200px] overflow-auto pr-2">
                        <p class="text-white mt-5 font text-xl font-bold text-justify" id="judul2">VISI :</p>
                        <p class="text-slate-300 mt-2 font font-normal text-justify" id="judul2">Menjadikan siswa dan siswi SMK Telesandi menjadi pribadi yang berakhlak mulia, berkualitas, dan kolaboratif yang dilandasi keimanan dan kejujuran.</p>
                        <p class="text-white mt-5 font text-xl font-bold text-justify" id="judul2">MISI :</p>
                        <p class="text-slate-300 mt-2 font font-normal text-justify" id="judul2">1. Membimbing para siswa dan siswi untuk lebih disiplin dan bertanggung jawab.</p>
                        <p class="text-slate-300 mt-2 font font-normal text-justify" id="judul2">2. Menjadikan siswa dan siswi lebih aktif berpartisipasi dalam kegiatan yang diadakan sekolah.</p>
                        <p class="text-slate-300 mt-2 font font-normal text-justify" id="judul2">3. Mendedikasikan keanggotaan OSIS disetiap acara disekolah.</p>
                        <p class="text-white mt-5 font text-xl font-bold text-justify" id="judul2">PROGRAM KERJA :</p>
                        <p class="text-slate-300 mt-2 font font-normal text-justify" id="judul2">1. Mengadakan ajang lomba kreativitas siswa bidang kesenian ketika ada peringatan hari hari besar.</p>
                        <p class="text-slate-300 mt-2 font font-normal text-justify" id="judul2">2. Mengadakan rapat rutin 1 atau 2 munggu sekali guna membahas pemasukan dan pengeluaran uang kas osis serta evaluasi pasca event yang dilakukan guna memperbaiki hal hal yang masih kurang baik.</p>
                        <p class="text-slate-300 mt-2 font font-normal text-justify" id="judul2">3. Membuat jadwal adzan sholat dzuhur dan ashar bagi setiap kelas.</p>
                    </div>
                    <div class="flex w-full">
                        <div class="md:mx-auto lg:mx-0 flex flex-wrap">
                            ...
                            <form action="/kandidats2" method="POST" id="myForm">
                                @csrf
                                <input type="submit" id="tombol2" class="bg-[#f4c304] py-2 px-16 rounded-lg mt-8 font-semibold text-lg hover:bg-yellow-600 transition ease-out duration-300 hover:text-white" value="Pilih Saya">
                            </form>
                        </div>
                    </div>
